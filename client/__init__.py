...
class JIASClient:
	...
	def buy_plane(self, airline_id, plane_id):
		return self.post("purchase_plane", {"airline_id": airline_id, "plane_id": plane_id})
	...
	def buy_route(self, airline_id, route_id):
		return self.post("purchase_route", {"airline_id": airline_id, "route_id": route_id})

	def fly_route(self, airline_id, route_id, plane_id):
		return self.post(
			"fly_route", {"airline_id": airline_id, "route_id": route_id, "plane_id": plane_id},
		)
